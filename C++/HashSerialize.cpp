...
// Сохранение Hash в текстовый файл
void HashSerializer::saveToFile(const Hash& table, const string& filename) {
...
// Загрузка Hash из текстового файла
void HashSerializer::loadFromFile(Hash& table, const string& filename) {
...
// Бинарное сохранение Hash
void HashSerializer::saveToBinaryFile(const Hash& table, const string& filename) {
...
// Бинарная загрузка Hash
void HashSerializer::loadFromBinaryFile(Hash& table, const string& filename) {
