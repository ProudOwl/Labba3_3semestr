...
TEST(HashTest, Hash_InsertUpdate) {
    Hash h(5);
    h.insert("Key1", "Val1");
...
TEST(HashTest, Hash_CollisionsAndErase) {
    Hash h(1);
    h.insert("A", "1");
    h.insert("B", "2");
    h.insert("C", "3");
...
TEST(HashTest, Hash_ShowEmpty) {
    Hash h(5);
    h.show();
    SUCCEED();
}

TEST(HashTest, Hash_SaveLoad) {
...
TEST(HashTest, Hash_Collision_DeleteMiddle) {
    Hash h(1); 
    h.insert("A", "1");
    h.insert("B", "2");
    h.insert("C", "3");
...
TEST(HashTest, Hash_UpdateValue) {
    Hash h(5);
    h.insert("Key", "Val1");
    h.insert("Key", "Val2");
